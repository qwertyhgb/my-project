...
| `g0_r_alignment_qc_automated_draft_0_3.yaml` | `G0-R-AUTOMATED` draft-0.3 | 2026-09-18 | `beda4bbf1065c9c8493fe41a640f5e4a257076b256438b8dd493cbedfa678198` | 完成「transform 类型修复 + 按 (pair, case_id) 分组校准 + 按 pair 阈值」的版本；**未在真实数据上运行过**（修复后未重跑），因发现两个新的 fail-open 缺陷而升为 draft-0.4 |
...
sha256sum configs/protocols/archive/g0_r_alignment_qc_automated_draft_0_3.yaml
# 期望：beda4bbf1065c9c8493fe41a640f5e4a257076b256438b8dd493cbedfa678198
```
